...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                .antMatchers("/usercenter/**","/demand/sos/add","/demand/buy/add","/institution/add", "/getOrderInfoAndGoto/**","/selectOrder/**").hasAuthority(SysRoleContants.ROLE_USER) //登陆后之后拥有“ADMIN”权限才可以访问/hello方法，否则系统会出现“403”权限不足的提示
