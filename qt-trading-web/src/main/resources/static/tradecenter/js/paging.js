(function(root, factory) {
	...
	Paging.prototype = {
		...
		bindToolbar: function() {
			var _this = this;
			var html = $('<li class="ui-paging-toolbar"><select class="ui-select-pagesize"></select> 到第 <input type="text" class="ui-paging-count"/> 页 <a href="javascript:void(0)">确定</a></li>');
			...
			str += '<option value="' + this.settings.pagesize + '">' + this.settings.pagesize + '条/页</option>';
			sel.html(str);
