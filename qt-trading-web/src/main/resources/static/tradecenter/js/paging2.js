(function(root, factory) {
	...
	Paging.prototype = {
		...
		format: function() {
			...
			html += '<li class="js-page-prev js-page-action ui-pager">' + this.settings.prevTpl + '</li><li class="js-page-prev js-page-action ui-pager left_page page_arrow"><</li>';
			if (this.pagecount > 6) {
			...
			html += '<li class="js-page-last js-page-action ui-pager">' + this.settings.lastTpl + '</li> <li class="js-page-last js-page-action ui-pager right_page page_arrow">></li>';
			html += '</ul>';
		...
		bindToolbar: function() {
			...
			str += '<option value="' + this.settings.pagesize + '">' + this.settings.pagesize + '条</option>';
			sel.html(str);
