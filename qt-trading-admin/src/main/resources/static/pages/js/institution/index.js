$(function () {
    ...
    var settings = {
        ...
        columnDefs:[{
            ...
            render: function (data, type, row, meta) {
                ...
                return '<a href="/institutionInfo?id=' + row.id + '" class="btn btn-sm green btn-outline filter-submit revise" data-value="'+ row.id +'">查看</a>' +
    ...
    $tbody.on('click','.isUsed',function () {
        ...
        if(status == 1){
            ...
            Common.Modal("服务商身份审核",id,"/api/institutionV2/audit");
        }
    });
