...
import com.qtdbp.tradingadmin.mapper.CustomizedMapper;
...
public class CustomizedService {
     ...
     */
    public Integer insertCustomizedData(CustomServiceModel custom) throws GlobalAdminException {
     ...
     * @throws GlobalAdminException
     */
    public boolean auditCustomizedData(CustomServiceModel custom) throws GlobalAdminException {
